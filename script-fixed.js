class ProductCounter {
    ...
    bindEvents() {
        ...
        const bulkStatesBtn = document.getElementById("bulkStatesBtn");
        ...
        bulkStatesBtn.addEventListener("click", () => this.viewBulkStates());
    }
        ...
        container.innerHTML = this.products.map(product => `
            <div class="product-item">
                <div class="product-header">
                    ...
                    <span class="product-name" onclick="app.openProductDetail(${product.id})">${this.escapeHtml(product.name)}</span>
                    <input 
                        type="text" 
                        class="product-note" 
    ...
    viewBulkStates() {
        window.location.href = "bulk-states.html";
    }
